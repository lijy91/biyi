...
static const Map<String,dynamic> en = {
  ...
  "page_desktop_popup": {
    ...
    "limited_banner_title": "Functionality is limited, please follow the tips to check.",
    ...
    "limited_banner_msg_allow_access_tip": "If there is no response after clicking \"Allow\", please click \"Go Settings\" to set it manually.",
    "limited_banner_msg_all_access_allowed": "The Screen extract text is enabled",
    "limited_banner_msg_all_access_not_allowed": "The required access are not allowed.\nPlease check and set again.",
    "input_hint": "Enter the word or text here",
    "text_extracting_text": "Extracting text...",
    "tip_translation_mode": "Current translation mode: {}",
    "tip_extract_text_from_screen_capture": "Capture screen area and recognize text",
    ...
    "msg_capture_screen_area_canceled": "Capture screen area has been canceled"
  },
  "page_language_chooser": {
  ...
  "page_setting_extract_text": {
    ...
    "pref_section_title_default_detect_text_engine": "Default detect text engine",
  ...
  "page_setting_interface": {
    ...
    "pref_section_title_max_window_height": "Maximum window height (logical pixels)",
  ...
  "page_setting_translate": {
    ...
    "pref_section_title_default_detect_language_engine": "Default detect language engine",
    "pref_section_title_translation_target": "Translation target",
    "pref_item_title_double_click_copy_result": "Double-click to copy translation result"
  },
  "page_settings": {
    "title": "Settings",
