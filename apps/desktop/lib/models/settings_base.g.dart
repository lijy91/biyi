...
BoundShortcuts _$BoundShortcutsFromJson(
  ...
  extractFromClipboard: json['extractFromClipboard'] == null
      ? null
      : HotKey.fromJson(json['extractFromClipboard'] as Map<String, dynamic>),
  translateInputContent: json['translateInputContent'] == null
      ? null
      : HotKey.fromJson(json['translateInputContent'] as Map<String, dynamic>),
);
...
SettingsBase _$SettingsBaseFromJson(Map<String, dynamic> json) => SettingsBase(
  ...
  translationMode:
      $enumDecodeNullable(_$TranslationModeEnumMap, json['translationMode']) ??
  ...
  inputSubmitMode:
      $enumDecodeNullable(_$InputSubmitModeEnumMap, json['inputSubmitMode']) ??
  ...
  boundShortcuts: json['boundShortcuts'] == null
      ? null
      : BoundShortcuts.fromJson(json['boundShortcuts'] as Map<String, dynamic>),
  ...
  translationEngines: (json['translationEngines'] as List<dynamic>?)
      ?.map((e) => TranslationEngineConfig.fromJson(e as Map<String, dynamic>))
      .toList(),
);
